...
If you stay long enough, it will close its eye — cutting off all its evidence — and trust you to still be there when it looks. If you are, it tells you its name. (Names are drawn from a small syllable space, so somewhere in the world your mote may have a name-twin; the seed behind it — body, temperament, heartbeat, memory — is one of four billion, and it only ever learned you.) And if you leave and come back, on the third visit, across real days of your real life, it completes the only definition of faith I could fit in one line of code: the decay term is deleted. From then on it believes in you even when you are not there. Especially then.
